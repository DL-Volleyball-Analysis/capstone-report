...
\subsubsection{開源貢獻}
\begin{itemize}
    \item 系統已開源至 GitHub：\url{https://github.com/DL-Volleyball-Analysis}
    \item 提供詳細的文檔和使用指南
    \item 促進學術社區交流與發展
\end{itemize}
...
\begin{itemize}
    \item \textbf{專案網站}：\url{https://github.com/DL-Volleyball-Analysis}
    \item \textbf{GitHub 儲存庫}：\url{https://github.com/DL-Volleyball-Analysis/volleyball_analysis_webapp}
    \item \textbf{展示影片}：\url{https://github.com/DL-Volleyball-Analysis/volleyball_analysis_webapp}
    \item \textbf{技術文檔}：\url{https://github.com/DL-Volleyball-Analysis/capstone-report}
\end{itemize}
...
\begin{itemize}
    \item \textbf{梁祐嘉}：ch993115@gmail.com
    \item \textbf{蔡佩穎}：tinatina62027@gmail.com
    \item \textbf{鍾佳芯}：aa0925129765@gmail.com
    \item \textbf{GitHub Issues}：\url{https://github.com/DL-Volleyball-Analysis/volleyball_analysis_webapp/issues}
    \item \textbf{討論區}：\url{https://github.com/DL-Volleyball-Analysis/volleyball_analysis_webapp/discussions}
\end{itemize}
